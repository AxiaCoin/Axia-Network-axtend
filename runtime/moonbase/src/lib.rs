...
parameter_types! {
	...
	/// These values are dictated by Axiaaxc for the allychain.
...
/// https://w3f-research.readthedocs.io/en/latest/axiaaxc/overview/2-token-economics.html#-2.-slow-adjusting-mechanism // editorconfig-checker-disable-line
///
...
parameter_types! {
	...
	pub const RelayNetwork: NetworkId = NetworkId::Axiaaxc;
...
pub type LocationToAccountId = (
	...
	SiblingAllychainConvertsVia<axiaaxc_allychain::primitives::Sibling, AccountId>,
...
parameter_types! {
	...
	/// We should increase this to a value close to what axiaaxc charges
	/// We are charging less to make it work with current reserve_transfer_assets issue
	/// TODO: Once fixed in axiaaxc v0.9.12, we should go back to 1_000_000_000
	/// https://github.com/axiatech/axiaaxc/pull/4144
...
pub type XcmBarrier = (
	...
	AllowKnownQueryResponses<AxiaaxcXcm>,
...
impl xcm_executor::Config for XcmExecutorConfig {
	...
	type ResponseHandler = AxiaaxcXcm;
...
pub type XcmRouter = (
	...
	cumulus_primitives_utility::ParentAsUmp<AllychainSystem, AxiaaxcXcm>,
...
impl cumulus_pallet_xcmp_queue::Config for Runtime {
	...
	type VersionWrapper = AxiaaxcXcm;
}
...
impl Contains<Call> for NormalFilter {
	fn contains(c: &Call) -> bool {
		match c {
			...
			Call::AxiaaxcXcm(method) => match method {
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		AxiaaxcXcm: pallet_xcm::{Pallet, Call, Storage, Event<T>, Origin, Config} = 28,
