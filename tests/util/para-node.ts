...
export type AllychainOptions = {
  chain:
    ...
    | "moonriver"
    | "moonbeam";
  relaychain?: "betanet-local" | "alphanet-local" | "axctest-local" | "axiaaxc-local";
...
export async function stopAllychainNodes() {
  killAll();
  await new Promise((resolve) => {
    // TODO: improve, make killAll async https://github.com/axiatech/axiaaxc-launch/issues/139
